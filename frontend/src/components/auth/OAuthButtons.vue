<template>
  <div class="space-y-3">
    ...
    <button
      ...
      :disabled="loading"
      @click="handleGoogle"
      class="w-full flex items-center justify-center gap-3 bg-white text-gray-900 border border-gray-200 py-3 px-4 text-sm font-medium hover:bg-gray-50 transition-colors disabled:opacity-50"
    >
